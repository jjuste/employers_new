      ...
      <div id="content" className="content-page content">
          ...
          <Row>
            <Col><span className="contField">
              <a href="/dcse/terminations.html">
                <Image src="/dcse/images/termIcon.svg" alt="" /><br />
                Not your employee?<br />Report a termination
              </a>
            </span></Col>
            <Col><span className="contField">
              <a href="/dcse/iwo_calc.html#calcR">
                <Image src="/dcse/images/calcIcon.svg" alt="" /><br />
                Withholding calculator
              </a>
            </span></Col>
            <Col><span className="contField">
              <a href="https://youtu.be/wpqW_LUiov0" target="_blank" rel="noopener noreferrer">
                <Image src="/dcse/images/videoIcon.svg" alt="" /><br />
                Calculator video
              </a>
            </span></Col>
          </Row>
          <Row>
            <Col> <span className="contField">
              <a
                ...
                <Image src="/dcse/images/lumpSum.svg" alt="" /><br />
            ...
            <Col><span className="contField">
              <a href="#emplPubsIP">
                <Image src="/dcse/images/emPubs.svg" alt="" /><br />
            ...
            <Col><span className="contField">
              <a
                ...
                <Image src="/dcse/images/eMail.svg" alt="" /><br />
        ...
        <p>
          Employers must <a href="https://nynewhire.com/index.jsp"
            title="Go to New Hire Reporting site; new window" target="_blank" rel="noopener noreferrer">report new
          ...
          Taxation and Finance <a href="https://tax.ny.gov/bus/wt/newhire.htm" title="New window"
            target="_blank" translate="no" rel="noopener noreferrer">New Hire Reporting</a> page.
        </p>
        <p>
        ...
        <p>
          ...
          earnings and benefits through a <a href="/dcse/pdfs/WHBR.pdf" target="_blank"
            title="New window with blank form" rel="noopener noreferrer"><span translate="no">Wage and Health Benefits Report</span></a>
        ...
        <p>
          The <a href="https://acf.hhs.gov/css/resource/e-iwo-answers-to-employers-questions#e-iwo-1"
            target="_blank" title="New window; federal child support site" rel="noopener noreferrer">electronic income
